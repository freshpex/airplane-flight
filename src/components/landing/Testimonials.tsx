...
const testimonials: Testimonial[] = [
  {
    ...
    quote: "EmmaAirways exceeded all my expectations. The business class experience was outstanding with comfortable seats, delicious meals, and attentive staff. Will definitely fly with them again!",
  ...
  },
  {
    ...
    quote: "The loyalty program offered by EmmaAirways is unmatched. I've earned enough points for multiple free flights and upgrades. Their app makes booking and managing trips incredibly easy.",
  ...
  },
  {
    ...
    quote: "Traveling with three kids can be stressful, but EmmaAirways made our family vacation so smooth. The staff were incredibly helpful, and the in-flight entertainment kept the children engaged the whole time.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">What Our Passengers Say</h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Discover why travelers choose EmmaAirways for their journeys around the world
            </p>
          </div>
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={cn(
                    ...
                    i === activeIndex ? "w-8 bg-qatar-burgundy" : "w-2.5 bg-neutral-300 hover:bg-neutral-400"
                  )}
