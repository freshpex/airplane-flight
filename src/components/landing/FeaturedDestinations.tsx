...
const destinations: Destination[] = [
  ...
  },
  {
    ...
    name: 'Tokyo',
    country: 'Japan',
    image: 'https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?q=80&w=2036&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    price: 799,
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="mb-10 text-center">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            Discover our hand-picked selection of popular destinations with exclusive deals
          </p>
        </div>
          ...
          {destinations.map((destination, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-4 text-white">
                ...
                <p className="text-sm font-medium text-white/80">{destination.country}</p>
