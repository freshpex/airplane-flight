...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Book luxury accommodations worldwide with exclusive deals and member benefits.',
    ...
    },
    {
      icon: MapPin,
      title: 'Plan Tours',
      description: 'Discover amazing experiences and activities at your destination with guided tours and local insights.',
    ...
    },
    {
      icon: Car,
      title: 'Car Rentals',
      description: 'Rent vehicles from trusted partners with convenient pickup locations and competitive rates.',
  ...
  const features = [
    {
      icon: Wifi,
      title: 'Free Wi-Fi',
      description: 'Stay connected with complimentary high-speed internet on all flights.'
    },
    {
      icon: Utensils,
    ...
    },
    {
      ...
      description: 'Comprehensive protection for your journey with flexible coverage options.'
    },
    {
      icon: Clock,
      title: '24/7 Support',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            From booking to landing, we provide world-class services that make your travel experience seamless and memorable.
          </p>
        </motion.div>
