...
const MobileFilterPanel = ({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent side="left" className="w-[300px] sm:w-[350px] p-0 overflow-auto">
            ...
            <div className="space-y-2">
              {[0, 1, 2].map((stops) => (
                <div key={stops} className="flex items-center">
                  ...
                  />
                  <label htmlFor={`stops-mobile-${stops}`} className="ml-2 text-gray-700 cursor-pointer">
              ...
              {availableAirlines.map((airline) => {
                ...
                return (
                  <div key={airline} className="flex items-center">
                    ...
                    />
                    <label htmlFor={`airline-mobile-${airline}`} className="ml-2 text-gray-700 flex items-center gap-2 cursor-pointer">
