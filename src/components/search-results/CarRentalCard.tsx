...
const CarRentalCard = ({ car, selectedCar, setSelectedCar }: CarRentalCardProps) => {
  return (
    <motion.div
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center pt-2 border-t">
          <div className="text-lg font-bold text-purple-700">
            ${car.price.amount} <span className="text-sm font-normal text-gray-600">per {car.price.period}</span>
          </div>
