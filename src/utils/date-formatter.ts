 ...
 */
export function formatDate(date: Date | string | null | undefined, formatString = 'yyyy-MM-dd'): string {
  if (!date) return '';
 ...
 */
export function parseDate(dateString: string | null | undefined, formatString = 'yyyy-MM-dd'): Date | null {
 ...
 * @returns The formatted date string
 */
export function friendlyDate(date: Date | string | null | undefined, formatString = 'MMM d, yyyy'): string {
  if (!date) return '';
