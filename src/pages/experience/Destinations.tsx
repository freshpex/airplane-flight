...
const popularDestinations = [
  {
    ...
    country: "France",
    image:
      "https://images.unsplash.com/photo-1499856871958-5b9357976b82?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
    description:
      "Experience the romance of the City of Light with its iconic landmarks and culinary delights.",
    price: "€349",
    flightTime: "2h 15m",
  },
  {
    ...
    description:
      "Visit the Big Apple for iconic skyscrapers, Broadway shows, and multicultural neighborhoods.",
    price: "$789",
    flightTime: "8h 30m",
  },
  {
    ...
    description:
      "Marvel at futuristic architecture and luxury shopping in this desert metropolis.",
    price: "₹42,500",
    flightTime: "3h 40m",
  },
  {
    ...
    description:
      "Discover a blend of ultramodern and traditional in Japan's bustling capital.",
    price: "¥96,000",
    flightTime: "11h 55m",
  },
  {
    ...
    description:
      "Relax on this stunning volcanic island with white-washed buildings and blue-domed churches.",
    price: "€420",
    flightTime: "3h 45m",
  },
  {
    ...
    description:
      "Enjoy breathtaking scenery, from Table Mountain to pristine beaches and vineyards.",
    price: "R8,500",
    flightTime: "11h 20m",
  },
];
        ...
        >
          ...
          <div className="aspect-[16/9] bg-gray-100 rounded-lg flex justify-center items-center">
            <p className="text-gray-500">
              Interactive world map would be displayed here with flight routes
            </p>
            <p className="text-sm text-gray-400 mt-2">
              (Requires a paid mapping API integration)
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div>
              ...
              <p className="max-w-2xl">
                Book your next adventure today and enjoy special fares to our
                newest destinations.
              </p>
            </div>
            <Button
              variant="qatar"
              className="mt-4 md:mt-0 whitespace-nowrap group"
            >
              Book Now{" "}
            ...
            {[
              {
                ...
                description:
                  "Everything you need to know about visa requirements, COVID-19 protocols, and entry regulations for different countries.",
                link: "/travel/travel-requirements",
              },
              {
                title: "Destination Guides",
                description:
                  "Detailed guides with insider tips, must-visit attractions, local cuisine recommendations, and cultural insights.",
                link: "#",
              },
              {
                title: "Seasonal Travel Calendar",
                description:
                  "Find the best time to visit your dream destinations with our comprehensive seasonal travel guide.",
                link: "#",
              },
            ].map((guide, index) => (
