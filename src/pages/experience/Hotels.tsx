...
const hotels = [
  {
    ...
    description:
      "Experience unparalleled luxury in the heart of Paris, with stunning views of the Eiffel Tower.",
  },
  {
    id: 2,
    ...
    price: "€380",
    image:
      "https://images.unsplash.com/photo-1602002418816-5c0aeef426aa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80",
    amenities: [
      "Private Pool",
      "Sea View",
      "Spa",
    ...
    description:
      "Cliffside luxury with breathtaking sunset views, featuring infinity pools and authentic Greek cuisine.",
  },
  {
    id: 3,
    ...
    description:
      "Designed for the modern business traveler, with state-of-the-art facilities and central location.",
  },
  {
    id: 4,
    ...
    description:
      "Paradise on earth with overwater villas, crystal clear waters and unmatched privacy.",
  },
  {
    id: 5,
    ...
    description:
      "A blend of traditional Japanese aesthetics and modern luxury in Tokyo's vibrant center.",
  },
  {
    id: 6,
    ...
    description:
      "Experience Arabian luxury in our desert oasis, with exclusive experiences and impeccable service.",
  },
];
            ...
            {[
              {
                ...
                description:
                  "Save up to 15% on hotel bookings with your SkyWays membership",
              },
              {
                icon: Check,
                title: "Best Price Guarantee",
                description:
                  "Find a lower rate and we'll match it, plus give you an additional 10% off",
              },
              {
                icon: Shield,
                title: "Secure Booking",
                description:
                  "Your data is protected with the latest encryption technology",
              },
              {
                icon: ArrowRight,
                title: "Earn Loyalty Points",
                description:
                  "Collect points on every stay and redeem for flights or future stays",
              },
            ].map((benefit, index) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                title: "Beach Resorts",
                image:
                  "https://images.unsplash.com/photo-1573843981267-be1999ff37cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
                count: "18 properties",
              },
              {
                title: "City Breaks",
                image:
                  "https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
                count: "41 properties",
              },
              {
                title: "Family-Friendly",
                image:
                  "https://images.unsplash.com/photo-1540541338287-41700207dee6?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
                count: "29 properties",
              },
              {
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              <h2 className="text-2xl font-bold mb-2">
                Join SkyWays Elite Hotel Program
              </h2>
              <p className="max-w-2xl">
                Enjoy exclusive benefits, earn points with every stay, and
                unlock premium perks like room upgrades, late check-out, and
            ...
            {[
              {
                ...
                answer:
                  "You earn points for every qualified stay at any SkyWays Hotel. Elite members earn bonus points based on their tier status. Points can be redeemed for free nights, room upgrades, or transferred to your flight miles.",
              },
              {
                question: "What is the cancellation policy?",
                answer:
                  "Cancellation policies vary by hotel and rate type. Most bookings offer free cancellation up to 24-48 hours before check-in. Always check the specific terms when booking.",
              },
              {
                question:
                  "Can I combine hotel bookings with flight reservations?",
                answer:
                  "Yes! Book both together for exclusive package rates and earn bonus loyalty points. Look for our flight+hotel packages for the best deals.",
              },
              {
                question: "Are breakfast and Wi-Fi included?",
                answer:
                  "Most SkyWays Hotels offer complimentary Wi-Fi. Breakfast inclusion varies by property and rate. Elite members often receive breakfast as a status benefit.",
              },
            ].map((faq, index) => (
        ...
        >
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-3/5 mb-6 md:mb-0">
              <h2 className="text-2xl font-bold mb-2">
                Download the SkyWays App
              </h2>
              <p className="text-gray-600 mb-6">
                Book and manage your hotel stays on the go. Enjoy mobile
                check-in, room selection, and exclusive mobile-only deals.
              </p>
            ...
            <div className="md:w-2/5 text-center">
              <div className="bg-gray-200 h-48 rounded-lg flex items-center justify-center">
                <p className="text-gray-500">
                  App screenshot would appear here
                </p>
              </div>
            </div>
          </div>
