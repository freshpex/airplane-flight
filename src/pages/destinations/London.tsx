        ...
        <div className="mb-12">
          <Tabs defaultValue="overview" className="w-full">
            <TabsList className="w-full grid grid-cols-4 mb-8">
              ...
              <TabsTrigger value="attractions" className="py-3">
                Attractions
              </TabsTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="md:col-span-2">
                    ...
                    <p className="text-gray-600 mb-6">
                      ...
                      a 21st-century city with history stretching back to Roman
                      ...
                      complex, and the entire city.
                    </p>
                    <p className="text-gray-600 mb-6">
                      As one of the world's most visited cities, London has
                      something for everyone: from history and culture to fine
                      food and exceedingly good times. With such diversity,
                      London's cultural dynamism makes it among the world's most
                      international cities. It is a city of ideas – an innovator
                      of art and culture.
                    </p>
                    <div className="mb-6">
                  ...
                  <div>
                    ...
                    <div className="bg-purple-50 rounded-xl p-6">
                      ...
                      <p className="text-sm text-gray-600 mb-4">
                        Our travel specialists can create a personalized London
                  ...
                  {[
                    {
                      ...
                      description:
                        "The iconic clock tower and seat of the UK government, located on the banks of the River Thames.",
                      image:
                        "https://images.unsplash.com/photo-1529655683826-aba9b3e77383?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
                      rating: 4.7,
                      duration: "1-2 hours",
                      price: "Free (exterior)",
                    },
                    {
                      ...
                      description:
                        "Historic castle on the north bank of the River Thames, home to the Crown Jewels and famous ravens.",
                      image:
                        "https://images.unsplash.com/photo-1592509255531-161181e0cb8a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
                      rating: 4.8,
                      duration: "3-4 hours",
                      price: "£29.90",
                    },
                    {
                      name: "British Museum",
                      description:
                        "World-class museum of human history and culture, with a permanent collection of over 8 million works.",
                      image:
                        "https://images.unsplash.com/photo-1574236079420-f04e5c0e0847?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
                      rating: 4.9,
                      duration: "3-5 hours",
                      price: "Free",
                    },
                    {
                      name: "London Eye",
                      description:
                        "Massive observation wheel offering panoramic views of the city skyline.",
                      image:
                        "https://images.unsplash.com/photo-1584541832053-6db39a669cd2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
                      rating: 4.6,
                      duration: "30 minutes",
                      price: "From £32.50",
                    },
                    ...
                    {[
                      {
                        ...
                        duration: "Full day",
                        image:
                          "https://images.unsplash.com/photo-1559562935-63fa68a3ead9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
                      },
                      {
                        destination: "Oxford",
                        distance: "95 km",
                      ...
                      },
                      {
                        ...
                        duration: "Full day",
                        image:
                          "https://images.unsplash.com/photo-1583122156490-d94b1454a8c6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
                      },
                      {
                        ...
                        duration: "Half day",
                        image:
                          "https://images.unsplash.com/photo-1592282725091-3446ea64d602?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1378&q=80",
                      },
                    ].map((trip, index) => (
                      <div
                        key={index}
              ...
              >
                ...
                <div className="mb-8">
                  <div className="p-4 bg-blue-50 rounded-lg mb-6">
                    <div className="flex items-start">
                      ...
                      <p className="text-sm text-blue-700">
                        Book your London hotel through SkyWays and receive
                        exclusive benefits including free airport transfers,
                        late checkout, and special room upgrades when available.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div
                        key={index}
                        className="grid grid-cols-1 md:grid-cols-3 bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100"
                      >
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  ...
                  <p className="text-gray-600 text-sm mb-6">
                    London has many distinct areas, each with its own character.
                    Here's a guide to help you choose the best location for your
                    stay.
                  </p>
                    ...
                    {[
                      {
                        area: "Covent Garden",
                        description:
                          "Central location with theaters, shopping, and dining.",
                        bestFor: [
                          "First-time visitors",
                          "Theater enthusiasts",
                          "Shopping",
                      ...
                      },
                      {
                        area: "Westminster",
                        description:
                          "Home to iconic landmarks and government buildings.",
                        bestFor: [
                          "Sightseeing",
                      ...
                      },
                      {
                        area: "South Bank",
                        description:
                          "Cultural hub along the Thames with great views.",
                        bestFor: [
                          "Arts & culture",
                          "River views",
                          "Family attractions",
                      ...
                      },
                      {
                        area: "Shoreditch",
                        description:
                          "Trendy area with hip bars, street art, and markets.",
                        bestFor: [
                          "Nightlife",
                          "Street art",
                          "Trendy restaurants",
                      ...
                      },
                      {
                        area: "Kensington",
                        description:
                          "Upscale area with museums and beautiful parks.",
                        bestFor: ["Luxury stays", "Museums", "Shopping"],
                      },
                      {
                        area: "Camden",
                        description:
                          "Vibrant district known for its markets and music scene.",
                        bestFor: [
                          "Alternative culture",
                          "Markets",
                          "Live music",
            ...
            <TabsContent value="flights" className="mt-0">
              ...
              >
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm mb-8">
                  <h3 className="text-lg font-semibold mb-4">
                    SkyWays Direct Flights to London
                  </h3>
                      ...
                      {[
                        {
                          ...
                          transport:
                            "Tube (Piccadilly Line), Heathrow Express, Taxis",
                        },
                        {
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            For the best deals, book your London flights 2-3
                            months in advance. Prices typically increase within
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Flights from the east coast of the US take
                            approximately 7-8 hours, while west coast flights
                            take 10-11 hours.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Elite members receive priority check-in, extra
                            baggage allowance, and access to lounges at all
                            London airports.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                      <h3 className="text-lg font-semibold">
                        Special London Flight + Hotel Package
                      </h3>
                      <p className="text-sm text-gray-600">
                        Save up to 25% when you book your flight and hotel
                        together.
                      </p>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                country: "Italy",
                image:
                  "https://images.unsplash.com/photo-1555992828-ca4dbe41d294?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=764&q=80",
              },
              {
                city: "Amsterdam",
                country: "Netherlands",
                image:
                  "https://images.unsplash.com/photo-1534351590666-13e3e96b5017?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
              },
              {
                city: "Barcelona",
                country: "Spain",
        ...
        >
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl overflow-hidden shadow-lg text-white p-8 text-center">
            ...
            <p className="max-w-2xl mx-auto mb-8">
              From historic landmarks to vibrant culture, London has something
              for everyone. Book your SkyWays flight today and start your London
              adventure!
            </p>
