  ...
  return (
    ...
    >
      <div className="max-w-5xl">
        ...
        >
          <div className="bg-green-50 border border-green-100 rounded-xl p-6 md:p-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Our goal is to achieve net-zero carbon emissions by 2050, with significant milestones along the way. This commitment 
              extends beyond environmental concerns to encompass social responsibility and governance practices that ensure 
        ...
        >
          <h2 className="text-2xl font-bold mb-6 text-gray-900">Key Initiatives & Progress</h2>
              ...
              <div key={index} className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div className="mb-3">
                  <div className="flex justify-between mb-1">
                    <span className="text-gray-700 font-medium">Target: {initiative.target}</span>
                ...
                <Button variant="link" className="text-purple-800 p-0 font-medium">
                  Learn More
                </Button>
              </div>
            ))}
        ...
        >
          <h2 className="text-2xl font-bold mb-6 text-gray-900">Fleet Modernization</h2>
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 p-6 md:p-8">
                <h3 className="text-xl font-semibold mb-4 text-gray-900">Next-Generation Aircraft</h3>
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Our fleet modernization program focuses on acquiring the most fuel-efficient aircraft available, 
                  reducing both emissions and noise pollution. Our newer aircraft consume up to 25% less fuel and 
                  produce significantly lower emissions compared to the previous generation.
                </p>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">25-30% reduced fuel consumption</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-6 w-6 rounded-full bg-green-100 flex items-center justify-center mr-3 flex-shrink-0">
                      <Leaf className="h-3.5 w-3.5 text-green-800" />
                    </div>
                    <span className="text-gray-700">50% reduced noise footprint</span>
                  </li>
                  <li className="flex items-start">
                    <div className="h-6 w-6 rounded-full bg-green-100 flex items-center justify-center mr-3 flex-shrink-0">
                      <Leaf className="h-3.5 w-3.5 text-green-800" />
                    </div>
                    <span className="text-gray-700">Extended range with lower emissions</span>
                  </li>
                </ul>
        ...
        >
          <h2 className="text-2xl font-bold mb-6 text-gray-900">Sustainability Reports & Resources</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Annual Sustainability Report</h3>
              <p className="text-gray-700 mb-4">Our comprehensive review of environmental initiatives, targets, and progress.</p>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Community Programs</h3>
              <p className="text-gray-700 mb-4">Learn about our environmental initiatives in communities around the world.</p>
              <Button variant="outline" className="w-full border-purple-800 text-purple-800 hover:bg-purple-50">
                Explore Programs
              </Button>
            </div>
