      ...
      <div className="max-w-4xl">
        ...
        >
          <section>
            ...
            <p>
              If you do not agree to these Terms, please do not use our Services. We reserve the right to modify these Terms at 
              any time. Your continued use of our Services following any changes constitutes your acceptance of the revised Terms.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">4. Booking and Reservations</h2>
            <p className="mb-4">
              When making a booking through our Services:
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li>You must provide accurate and complete passenger information.</li>
              <li>All bookings are subject to availability and confirmation.</li>
              <li>You must comply with all applicable travel requirements, including visa and passport regulations.</li>
              <li>Additional terms may apply as specified in our Conditions of Carriage.</li>
            </ul>
            <p>
              Payment for bookings is processed securely, and we may use third-party payment processors. By providing payment 
              information, you represent that you are authorized to use the payment method.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">5. Cancellation and Refund Policy</h2>
            <p className="mb-4">
              Cancellation and refund policies vary based on the fare type and other factors. Please refer to the specific 
              conditions attached to your booking at the time of purchase. In general:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Refunds are processed according to the original payment method used for the booking.</li>
              <li>Special rules may apply during disruptions, as outlined in our Conditions of Carriage.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              You may not reproduce, modify, distribute, display, perform, or create derivative works from any content without 
          ...
          <section>
            ...
            <p>
              Our total liability for any claims arising from or related to these Terms or your use of our Services shall not 
          ...
          <section>
            ...
            <p className="mb-4">
              Any dispute arising from or related to these Terms or our Services shall first be attempted to be resolved through 
              good-faith negotiations. If the dispute cannot be resolved through negotiations, it shall be submitted to binding 
              arbitration in accordance with the rules of [Arbitration Association].
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">11. Severability</h2>
            <p>
              If any provision of these Terms is found to be invalid, illegal, or unenforceable, the remaining provisions shall 
              continue in full force and effect. The invalid or unenforceable provision shall be replaced by a valid and enforceable 
