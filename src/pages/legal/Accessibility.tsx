      ...
      <div className="max-w-4xl">
        ...
        >
          <section>
            ...
            <p className="mb-4">
              At SkyWays Airlines, we believe that air travel should be
              accessible to everyone. We are committed to providing an inclusive
              and supportive travel experience for all our passengers, including
              those with disabilities or mobility challenges.
            </p>
            <p>
              We continuously work to improve our services, facilities, and
              website to ensure they are accessible and meet the diverse needs
              of our passengers. This accessibility statement outlines our
              approach and the resources available to help you plan and enjoy
          ...
          <section>
            ...
            <p className="mb-4">
              We strive to ensure that our website follows the Web Content
              Accessibility Guidelines (WCAG) 2.1 at Level AA. Our website is
              designed to be:
            </p>
          ...
          <section>
            ...
            <p className="mb-4">
              We recommend contacting our Special Assistance team at least 48
              hours before your flight to arrange any necessary support
            ...
            <p className="mb-4">
              We work closely with airports to ensure accessibility throughout
              your journey:
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li>
                Designated check-in counters for passengers requiring special
                assistance
              </li>
            ...
            <ul className="list-disc pl-5 space-y-2 mb-4">
              ...
              <li>
                Accessible in-flight entertainment with closed captions and
                audio descriptions on select content
              </li>
            </ul>
            ...
            <div className="bg-purple-50 border border-purple-100 rounded-xl p-6 my-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mb-4">
                    Our dedicated team is available to help with any questions
                    or arrangements for your journey.
                  </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                European Union Regulation (EC) No 1107/2006 concerning the
          ...
          <section>
            ...
            <p className="mb-4">
              We are committed to continually improving our accessibility
              features and services. We regularly:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>Conduct accessibility audits of our digital platforms</li>
              <li>
                Train our staff on disability awareness and assistance
                procedures
              </li>
              <li>Collect feedback from passengers with disabilities</li>
              <li>
                Work with disability advocacy organizations to identify areas
                for improvement
              </li>
              <li>
                Implement new technologies and solutions to enhance
                accessibility
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              We value your feedback on our accessibility features and services.
