      ...
      <div className="max-w-4xl">
        ...
        >
          <section>
            ...
            <p>
              By using our services, you consent to the practices described in this Privacy Policy. We may update this policy 
              periodically, and we encourage you to review it regularly for any changes.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mb-4 space-y-1">
              ...
              <li>Identification details (passport number, government-issued ID)</li>
              <li>Payment information (credit card details, billing information)</li>
              <li>Travel preferences and frequent flyer information</li>
              <li>Special service requests (dietary requirements, mobility assistance)</li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Airlines, airports, and other travel-related entities necessary to fulfill your booking</li>
              <li>Payment processors and financial institutions</li>
              <li>Government agencies and regulatory authorities as required by law</li>
              <li>Legal advisors and professional consultants</li>
            </ul>
            <p className="mt-4">
              We implement appropriate safeguards when sharing your data and require third parties to respect the security of your 
              information and treat it in accordance with applicable laws.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              We use cookies and similar technologies to enhance your experience on our website and app. These technologies 
              help us understand how visitors use our services, remember your preferences, and provide personalized features.
            </p>
            <p className="mb-4">
              You can manage your cookie preferences through your browser settings. Please note that disabling certain cookies 
          ...
          <section>
            ...
            <p>
              As a global airline, we may transfer your personal information to countries outside your home country. We ensure 
              that such transfers comply with applicable data protection laws and that appropriate safeguards are in place to 
