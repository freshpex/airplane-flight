        ...
        >
          <section>
            ...
            <p>
              ...
              actions. They are not harmful and do not contain personal
          ...
          <section>
            ...
            <p className="mb-4">
              SkyWays Airlines uses cookies and similar technologies for various
              purposes, including:
            </p>
            ...
            <p className="mb-4">
              ...
              management, and account access. You cannot disable these cookies
              through our system.
            </p>
            ...
            <p className="mb-4">
              ...
              allow us to track metrics like the number of visitors, traffic
              sources, and which pages are most popular. This helps us improve
            ...
            <p className="mb-4">
              ...
              all of these features may not work properly.
            </p>
            ...
            <p>
              These cookies are used to deliver relevant advertisements based on
              your interests. They also help measure the effectiveness of
              advertising campaigns. These cookies may be set through our site
              by our advertising partners and help build a profile of your
              interests.
            </p>
          </section>
              ...
              <table className="w-full border-collapse mb-4">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="px-4 py-2 border border-gray-300">
                      To recognize and maintain your session while browsing our
                      website
                    </td>
                    <td className="px-4 py-2 border border-gray-300">
                      Temporary (deleted when browser is closed)
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
                    ...
                    <td className="px-4 py-2 border border-gray-300">
                      To remember your preferences and settings for future
                      visits
                    </td>
                    <td className="px-4 py-2 border border-gray-300">
                      Varies (can be days, months, or years)
                    </td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">
                    ...
                    <td className="px-4 py-2 border border-gray-300">
                      Set directly by SkyWays for essential website
                      functionality
                    </td>
                  ...
                  <tr className="bg-gray-50">
                    ...
                    <td className="px-4 py-2 border border-gray-300">
                      Set by third parties for analytics, advertising, and
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              instructions on how to manage cookies. Common browsers include:
            </p>
            <ul className="list-disc pl-5 space-y-1 mb-4">
              <li>Google Chrome</li>
            ...
            <p>
              You can also manage your cookie preferences through our Cookie
              Manager, which appears as a banner when you first visit our
              website. You can access this tool at any time by clicking the
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mb-4">
              ...
              <li>
                Social media plugins that may set cookies for sharing features
              </li>
            ...
            <p>
              ...
              our website. Please refer to their respective privacy policies for
              more information on how they use your data.
            </p>
          </section>
