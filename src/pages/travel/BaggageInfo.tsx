  ...
  const restrictedItems = [
    {
      ...
      description:
        "Containers must be 100ml or less and fit in a transparent, resealable plastic bag of 1 liter capacity.",
    },
    {
      category: "Electronic Devices",
      description:
        "Devices with lithium batteries must be carried in cabin baggage. Spare batteries are not allowed in checked baggage.",
    },
    {
      category: "Medical Equipment",
      description:
        "Notify airline in advance. Documentation may be required for certain medications and equipment.",
    },
    {
      category: "Baby Food and Milk",
      description:
        "Reasonable amounts allowed in carry-on when traveling with an infant or young child.",
    },
    {
      category: "Sports Equipment",
      description:
        "Most items allowed as checked baggage with special handling fees. Some restrictions apply.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            Your baggage allowance depends on your cabin class, loyalty tier,
            and route. Select your cabin class below to see your standard
            allowance.
          </p>
          ...
          >
            ...
            <TabsContent value="economy" className="mt-0">
              <BaggageAllowanceContent
                data={baggageAllowances.economy}
            ...
            <TabsContent value="business" className="mt-0">
              <BaggageAllowanceContent
                data={baggageAllowances.business}
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            If you need to bring more baggage than your standard allowance, you
            can purchase extra baggage. Booking in advance online is cheaper
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  These items are not allowed on board our aircraft under any
                  circumstances.
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  These items are allowed with certain limitations or require
                  special handling.
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700">
                    Different countries may have additional restrictions. Always
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-purple-100">
                Contact our baggage specialists for any questions about your
                specific needs.
              </p>
            </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-medium">
              {allowance.pieces} {allowance.pieces === 1 ? "bag" : "bags"}
            </div>
          </div>
        </div>
        <div className="flex items-center gap-2">
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm text-gray-500">Pieces</div>
                <div className="font-medium">
                  {data.cabinBaggage.pieces}{" "}
                  {data.cabinBaggage.pieces === 1 ? "bag" : "bags"}
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2">
        ...
        <CheckedBaggageCard
          allowance={data.checkedBaggage.standard}
          title="Standard Checked Baggage"
        />

        {/* Elite/Loyalty Checked Baggage */}
        <CheckedBaggageCard
          allowance={data.checkedBaggage.elite}
          title="Elite Member Baggage"
        />
      </div>
      ...
      <div className="bg-purple-50 p-4 rounded-lg flex items-start gap-3">
        ...
        <div>
          <h4 className="font-semibold text-purple-800 mb-1">
            Note for {cabinType} Passengers
          </h4>
          <p className="text-sm text-purple-700">
            Baggage allowances may vary by route and ticket type. Elite members
            of our loyalty program receive additional baggage benefits. Check
            your ticket or booking confirmation for your specific allowance.
          </p>
        </div>
      </div>
    </motion.div>
