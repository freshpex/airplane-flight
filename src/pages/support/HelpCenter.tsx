        ...
        >
                    ...
                    <ul className="space-y-3">
                      {category.topics.map((topic, idx) => (
                        <li key={idx}>
                          <a
                            href="#"
                            className="flex items-center text-gray-700 hover:text-purple-800 group"
                          >
          ...
          <section>
            <div className="flex justify-between items-center mb-6">
              ...
              <a
                href="#"
                className="text-purple-800 font-medium hover:underline hidden md:flex items-center"
              >
              ...
              {[
                {
                  ...
                  answer:
                    "You can change or cancel your flight through our website by logging into your account and navigating to 'My Bookings.' Select the booking you wish to modify and follow the prompts for changes or cancellation. Please note that fare conditions, including any change or cancellation fees, apply based on your ticket type.",
                },
                {
                  question: "What is the baggage allowance for my flight?",
                  answer:
                    "Baggage allowance varies based on your travel class, destination, and loyalty status. Economy class typically allows 30kg (66lbs) for checked baggage, Business class 40kg (88lbs), and First class 50kg (110lbs). Cabin baggage is limited to 7kg (15lbs) per passenger. For specific details, please check your booking confirmation or visit our baggage policy page.",
                },
                {
                  question:
                    "How early should I arrive at the airport before my flight?",
                  answer:
                    "We recommend arriving at the airport 3 hours before international flights and 2 hours before domestic flights. This allows sufficient time for check-in, security screening, and boarding procedures. During peak travel seasons, additional time may be required.",
                },
                {
                  question: "Can I select my seat in advance?",
                  answer:
                    "Yes, you can select your preferred seat when booking your flight or later through the 'Manage Booking' section on our website or mobile app. Some seat selections may incur additional fees depending on your fare type and loyalty program status.",
                },
                {
                  question:
                    "What special assistance services do you offer for passengers with disabilities?",
                  answer:
              ...
              {[
                {
                  ...
                  description:
                    "Get real-time updates on arrivals and departures",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Check in for your flight from 24h before departure",
                },
                {
