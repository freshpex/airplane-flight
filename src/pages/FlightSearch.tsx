              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8 flex items-center justify-center h-60">
                  <div className="text-center text-gray-500">
                    ...
                    <p>
                      Our hotel booking feature is currently under development.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8 flex items-center justify-center h-60">
                  <div className="text-center text-gray-500">
                    ...
                    <p>
                      Our car rental booking feature is currently under
                      development.
                    </p>
                  </div>
                </CardContent>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8 flex items-center justify-center h-60">
                  <div className="text-center text-gray-500">
                    ...
                    <p>
                      Our vacation package feature is currently under
                      development.
                    </p>
                  </div>
                </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                image:
                  "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
                price: "599",
              },
              ...
              >
                ...
                <Button
                  ...
                  onClick={() =>
                    console.log(`Searching flights to ${destination.city}`)
                  }
                >
                  <span className="sr-only">
                    View flights to {destination.city}
                  </span>
                </Button>
              </motion.div>
            ))}
            ...
            {[
              {
                title: "Summer Sale",
                description:
                  "Up to 25% off flights to select European destinations",
                badge: "Limited Time",
                image:
              ...
              },
              {
                ...
                description:
                  "Experience premium travel with 30% off business class flights",
                badge: "Premium",
                image:
                  "https://images.unsplash.com/photo-1540339832862-326df6633f6d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80",
                expiry: "Sep 15, 2023",
              },
            ].map((offer, index) => (
              <motion.div
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl overflow-hidden shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-5">
              <div className="md:col-span-3 p-8 text-white">
                ...
                <p className="mb-6">
                  Book flights, check in, manage your bookings, and access your
                  boarding passes all in one place. Enjoy exclusive app-only
                  deals and real-time flight notifications.
                </p>
